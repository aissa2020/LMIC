...
//-WET Template Labels
pageLabelMap.put("G01S001","Passer au contenu principal");
pageLabelMap.put("G01S002","Passer à «&#160;À propos de ce site&#160;»");
pageLabelMap.put("G01S003","Sélection de la langue");
pageLabelMap.put("G01S004","Recherche et menus");
pageLabelMap.put("G01S005","Recherche");
  	
//-FRENCH labels
pageLabelMap.put("P01S001","Thème de la base - Exemples pratiques - Boîte à outils de l'expérience Web");
...
pageLabelMap.put("P01S002","Bienvenue to the Labour Market Information Council Website");
...
pageLabelMap.put("P02S001","à Propos de Nous");
pageLabelMap.put("P02S002","à Propos de Nous");
...
pageLabelMap.put("P02S004","");
	...
	pageLabelMap.put("P02S007","The mandate of the Council is");
	pageLabelMap.put("P02S008","to improve the timeliness, reliability, and accessibility of LMI to facilitate decision making by students, workers, job searchers, employers, and policy makers, in support of a flexible, efficient labour market.");
