...
<jsp:attribute name="title">LMI Council | ${pageLabelMap['P03S001']}</jsp:attribute>	
  		...
  		<div class="hero-content-wrapper-inner">
  			<div class="cover-container">
  				<div class="inner cover mrgn-bttm-lg">
	  				<h1 id="wb-cont" class="mrgn-tp-lg">${pageLabelMap['P03S002']}</h1>
					<p class="page-caption">${pageLabelMap['P03S003']}</p>
				</div>
			</div>
		</div>
	</section>
